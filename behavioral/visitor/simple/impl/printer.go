...
func (printer *FilePrinter) Visit(resourceFile simple.ResourceFile) error {
...
func PrintCsvFile(resourceFile simple.ResourceFile)error {
	fmt.Println("打印CSV文件内容到控制台...",resourceFile.(*CsvFile).Path)
	return nil
}

func PrintTxtFile(resourceFile simple.ResourceFile)error {
